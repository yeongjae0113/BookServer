...
public class BookControllerUnitTest {
    ...
    @MockBean       // IoC 환경에 '가짜' Service Bean 생성함
    ...
    public void test2() {
        ...
        System.out.println("book: " + book);    // null 값이 리턴된다 !
    }
    ...
    public void 저장하기테스트() throws Exception {
        ...
        // ■ when : 행동을 지정
        // 어짜피 주입된 Service 는 가짜다.  Service 6메소드들은 제대로 동작 안한다.
        //                                ( 이경우 .저장하기(Book) )
    ...
    public void findAll_테스트() throws Exception {
        ...
        List<Book> books = List.of(
                new Book(1L, "스프링부트 따라하기", "유인아"),
                new Book(2L, "리액트 따라하기", "베리베리")
        );
        when(bookService.모두가져오기())  // 여기서 when 은? 모두 가져오기를 호출하면 books 를 리턴해라 !
                .thenReturn(books);
